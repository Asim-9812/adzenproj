...
class PersonalRecentActivities extends StatelessWidget {
  final bool isPortrait;
  const PersonalRecentActivities({required this.isPortrait,super.key});
            ...
            child: const Column(
              ...
              children: [
                Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text('Today',style: TextStyle(color: MyColors.white,fontSize: 12,fontWeight: FontWeight.w600),),
                    w08,
